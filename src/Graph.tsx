...
class Graph extends Component<IProps, {}> {
  ...
  componentDidMount() {
    ...
    if (this.table) {
      ...
      // add more attributes as per the requirement
      ...
      elem.setAttribute('column','["top_ask_price"]');     //allows us to focus on a particular part of a stock’s data along the y-axis
